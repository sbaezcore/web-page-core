  ...
  return (
    <footer className="mt-20 px-4 pb-4">
      <div className="max-w-[1600px] mx-auto bg-black text-white rounded-3xl overflow-hidden font-raleway font-medium text-[20px]">
        {/* Footer Top CTA */}
        <div className="text-center py-8 mx-12 md:mx-24 border-b-[2px] border-white ">
          <h2 className="text-2xl font-bold mb-4">{dict.readyToScale}</h2>
          <p className="text-white mb-8 w-full max-w-5xl mx-auto">
            {dict.supportGrowth}
          </p>
          <Link className="inline-block bg-gradient-to-r from-[#450CC2] to-[#2827E5] hover:from-[#560FF3] hover:to-[#560FF3] text-white px-8 py-3 rounded-lg font-bold hover:scale-[1.2] transform transition-all duration-300 shadow-md origin-center" href="https://calendly.com/alejandro-torres-thecoreresources/30min?month=2026-05" target="_blank" rel="noopener noreferrer">
