...
export default function BuildTeamsContent({ dict }: { dict: any }) {
  ...
  return (
    <main className="w-full mx-auto overflow-hidden">
      {/* Hero Section */}
      <section className="relative pt-16 pb-16 md:pt-5 md:pb-20 px-6 xl:px-8 max-w-7xl mx-auto group">
            ...
            <FadeInSection>
              <div className="bg-gray-100/50 rounded-[2.5rem] p-6 lg:p-10 group transition-all duration-300 hover:shadow-lg cursor-default">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                  ...
                  <div className="bg-white group-hover:bg-[#560FF3] transition-colors duration-300 rounded-[2rem] p-8 shadow-sm flex flex-col h-full">
